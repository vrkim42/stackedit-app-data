...
#### 指针的便利性
打个比方，我们在使用调用函数时，要声明函数类型和他所接受的参数，而我们在主函数中调用函数之后，函数在执行时会出现“值传”现象，即传递的是那些参数的复制品，这些复制品会存放在堆内存中，在函数执行完成之后销毁，相应的，如果这些复制品太多太大，可能会导致程序不运行或者执行速度显著降低。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU1OTEwODM3OCwxMDUxMDE4NTQ2XX0=
-->