...
A Novel Fault Diagnosis Method for Complex Chemical Process" by Dr. Linlin Liang, Dehua Zhang; Kuangji Zuo, which you submitted to the International Scientific Journal Engineering Applications of Artificial Intelligence have now been received.

I regret to have to inform you that the referees recommended against acceptance of the paper for publication in the journal Engineering Applications of Artificial Intelligence. Please see below a copy of the various reviewer's remarks.

We sincerely appreciate having been given the opportunity to consider this manuscript; I hope that you will find the reviewer's remarks pertinent and helpful.
...
Reviewer #1: This article proposes the Bayesian-LSTM algorithm for fault diagnosis of complex chemical processes, focusing on the characteristics of temporal correlation, nonlinearity, high-dimensional, and strong coupling. However, similar studies were previously reported. Finally, there are not enough innovative ideas in this paper. The detailed comments are as follows.
...
In Figure 3, in the modelling phase, the noise should also be added to the validation data, which should be fed to the "test model" block. In the online monitoring part, when no fault is detected, it should go to the next online sample at the very top, not go to the "diagnosis result" box.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0Mjg0MzgwOCw2Nzk2MTU2MywxMTU4Nz
gxNzEsLTc2MTQ2MTc5N119
-->